...
-- Insert sample projects with multiple images (image_urls array)
-- Using Unsplash for beautiful placeholder images
...
INSERT INTO team_members (name, role, description, skills, display_order) VALUES
('James Raphael', 'Creative Director & Developer', 'Passionate about creating beautiful interfaces and seamless user experiences.', ARRAY['UI/UX Design', 'Frontend Development', 'Creative Strategy'], 1),
('Kelvin', 'Lead Developer & Designer', 'Expert in turning complex ideas into elegant, functional solutions.', ARRAY['Full-Stack Development', 'Product Design', 'Technical Architecture'], 2)
ON CONFLICT DO NOTHING;
